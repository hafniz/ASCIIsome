...
namespace ASCIIsome
{
    public static class ApplicationInfo
    {
        ...
        public static Version ApplicationVersion { get; } = new Version(0, 0, 34, 30); // TODO: [HV] Automatically generate (and format) version info in ApplicationInfo and AssemblyInfo class on building/publishing 
